...
def main():
    ...
    signalMap = {
        ...
        "FB_EbaraEVA" : { # ST_MechPump
            ...
            "i_xAlarmOK" : "?unmapped",
            "i_xIsRun" : "?unmapped"},
        "FB_EbaraDryPump" : { # ST_MechPump
            "q_xMPStart" : "i_xRun",
            "q_xBPStart" : "?unmapped",
            "i_xMPStatus" : "?unmapped",
            "i_xBPStatus" : "?unmapped",
            "i_xWarning" : "?unmapped",
            "i_xAlarm" : "?unmapped",
            "i_xRemote" : "?unmapped"},
        "FB_PTM_Ebara_010M" : { # ST_MechPump
            "q_xStart" : "i_xRun",
            "q_xStop" : "?unmapped",
            "q_xReset" : "?unmapped",
            "q_xProtection" : "?unmapped",
            "q_xSetSpeed" : "?unmapped",
            "q_iSpeedSet" : "?unmapped",
            "i_xDecel" : "?unmapped",
            "i_xAccel" : "?unmapped",
            "i_xRotate" : "?unmapped",
            "i_xNCFault" : "?unmapped",
            "i_xAtSpd" : "?unmapped",
            "i_iRawSpeed" : "?unmapped",
            "i_xAlarm" : "?unmapped",
            "i_iTempMon" : "?unmapped",
            "i_iCurrentMon" : "?unmapped"},
        "FB_PTM_Ebara_011M" : { # ST_MechPump
            "q_xStart" : "i_xRun",
            "q_xStop" : "?unmapped",
            "q_xReset" : "?unmapped",
            "q_xProtection" : "?unmapped",
